...
export function getCommonConfigStyles() {
  return `
      ...
      .config-row input, .config-row select { flex: 0 0 auto; min-width: 120px; padding: 8px 12px; border: 1px solid var(--ha-color-border-neutral-quiet); border-radius: var(--ha-border-radius-sm); background: var(--ha-color-form-background); color: var(--primary-text-color); font-family: inherit; }
      ...
      .section-title { font-size: 1.1em; font-weight: 600; color: var(--primary-text-color); margin-top: 16px; margin-bottom: 8px; padding-bottom: 4px; border-bottom: 1px solid var(--ha-color-border-neutral-quiet); }
